        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem', alignItems: 'start' }}>
          ...
          <div style={{ padding: '0.5rem 0' }}>
            <form style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '520px' }}>
              ...
              <button type="button" style={{ padding: '0.75rem 1.25rem', width: '100%', textAlign: 'center', backgroundColor: '#e6a800', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }}>Submit Inquiry</button>
            </form>
          </div>
        </div>
      </section>
